...
export const COPY = {
  ...
  web: {
    ...
    bribe: { late: (time: string) => `迟到 · ${time}`, title: '主管把你叫到一边。', expressCancelled: '快车取消过一次，重新叫车后仍然迟到了。', subwayFailed: '地铁发生信号故障，额外耽误了 15 分钟。', subwayMissedStop: '你因太困在地铁上睡着坐过站了，用时增加了 20 分钟。', body: (cost: number) => `你懂什么意思，用 ¥${cost} 贿赂主管，这次迟到可以不计入记录，下不为例。`, pay: (cost: number) => `支付 ¥${cost}`, decline: '拒绝' },
  },
  cli: {
